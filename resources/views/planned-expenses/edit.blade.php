    ...
    <div class="row justify-content-md-center">
        <div class="col-md-6">
            <div class="card p-3">
                ...
                <div class="card-body">
                    <form autocomplete="off" action="{{ route('planned-expenses.update', $plannedExpense) }}" method="POST">
                        @method('PUT')
                        @if ($errors->any())
                        ...
                        <div class="form-group mb-2">
                            ...
                            <input type="text" autocomplete="off" class="form-control" id="amount" name="amount" value="{{ old('amount', money_input($plannedExpense->amount)) }}">
                        </div>
                        <div class="form-group mb-2">
                            <label for="day">Day Number:</label>
                            <input type="number" autocomplete="off" class="form-control" id="day" name="day" value="{{ old('day', $plannedExpense->day) }}">
                        </div>
                        <div class="form-group mb-2">
                            <label for="month">Month Number:</label>
                            <input type="number" autocomplete="off" class="form-control" id="month" name="month" value="{{ old('month', $plannedExpense->month) }}">
                        </div>
                        <div class="form-group mb-2">
                            <label for="reminder_days">Reminder Days:</label>
                            <input type="number" autocomplete="off" class="form-control" id="reminder_days" name="reminder_days" value="{{ old('reminder_days', $plannedExpense->reminder_days) }}">
                        </div>
                        <div class="form-group mb-2">
