...
<div class="card">
    ...
    @enderror
        ...
        <ul class="list-group list-group-flush">
            ...
            <li class="list-group-item"><strong>From:</strong> <a href="{{ route('bills.show', $transfer->from) }}">{{ $transfer->from->name_with_user }}</a></li>
            <li class="list-group-item"><strong>To:</strong> <a href="{{ route('bills.show', $transfer->to) }}">{{ $transfer->to->name_with_user }}</a></li>
